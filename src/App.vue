...
<style>
  #app {font-family: 'Avenir', Helvetica, Arial, sans-serif;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;color: #2c3e50;margin: 0px; padding:0px;font-size:14px;}
  body{margin: 0px;padding:0px;background: #ecf0f1;}
  a{text-decoration: none;color: #2c3e50;}
  a:hover{text-decoration: none;color: #00c1dc;}
  .clear{clear: both;}
  .border-top{border-top:1px solid #e5e5e5;}
  .border-bottom{border-bottom:1px solid #e5e5e5;}
  .border-left{border-left:1px solid #e5e5e5;}
  .border-right{border-right:1px solid #e5e5e5;}
  .bg-dialog{position: fixed;top:0;left:0;background: #000;opacity: 0.5;width: 100%;height: 100%;z-index: 1;}
